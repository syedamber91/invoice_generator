...
<style>
    ...
    /* Sidebar styling - ALL TEXT VISIBLE */
    ...
    /* Sidebar header - Dark text on gold */
    .sidebar-header {
        background: linear-gradient(135deg, #C9A961 0%, #D4AF37 100%);
        padding: 1rem;
        border-radius: 10px;
...
with st.sidebar:
    ...
    page_selection = st.radio(
        "Go to:",
        ["📝 Quotation Generator", "⚙️ Manage Products"],
        key="nav_selection",
...
if page_selection == "📝 Quotation Generator":
    # ==========================================
    ...
    <div class="main-header">
        ...
        <p>Add, edit, import, and manage your product catalog</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if not products_df.empty:
        ...
        with btn_col3:
            st.caption(f"📦 **{len(products_df)}** products in database")
    else:
        st.info("📭 No products in database. Add your first product above or import from a file below.")
